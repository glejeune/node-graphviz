 ...
 * Render in-memoty
 *
 * @param {String} type The output type (png, jpeg, ps, ...)
 * @param {Function} callback Render callback
 * @param {Function} errback Error callback
 */
Graph.prototype.render = function(type, callback, errback) {
  var cmd = this.gvPath + this.use;
  var rendered = ''
  graphviz = spawn(cmd, ['-T' + type]);
